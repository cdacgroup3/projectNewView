...
<body>
	<header class="container-fluid" style="background-color:#01704f">
		<div class="row" style="background-color:#01704f">
			<nav class="navbar navbar-expand-lg">
				<a class="navbar-brand" href="#" style="background-color:#01704f">
					<img src="assets/images/logo3.png" height="85px">
				</a>
				<div class="navbar-collapse justify-content-end">
					<ul class="navbar-nav">
						<li class="nav-item">
							<a class="nav-link h5 mr-10 text-light" href="" >Why Us?</a>
						</li>
						<li class="nav-item">
							<a class="nav-link h5 text-light" href="">Features</a>
						</li>
						<li class="nav-item">
							<a class="nav-link h5 text-light" href="">Brands</a>
						</li>
						<li class="nav-item">
							<a class="nav-link h5 text-light" href="">Contact Us</a>
						</li>
						<li class="nav-item">
							<a class="nav-link h5 text-light" href="">Sign Up/Sign In</a>
						</li>
					</ul>
				</div>
